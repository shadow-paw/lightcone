...
// Polling method
#define LIGHTCONE_POLL_SELECT 0
#define LIGHTCONE_POLL_EPOLL  1
#define LIGHTCONE_POLL_KQUEUE 2

// Choose a poller implementation
#if defined(PLATFORM_WIN32) || defined(PLATFORM_WIN64)
    #define LIGHTCONE_POLL_IMPLEMENTATION LIGHTCONE_POLL_SELECT
#elif defined(PLATFORM_BSD) || defined(PLATFORM_MAC) || defined(PLATFORM_IOS)
    #define LIGHTCONE_POLL_IMPLEMENTATION LIGHTCONE_POLL_KQUEUE
#elif defined(PLATFORM_LINUX) || defined(PLATFORM_ANDROID)
    #define LIGHTCONE_POLL_IMPLEMENTATION LIGHTCONE_POLL_EPOLL
